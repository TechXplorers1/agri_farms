...
class BookingDetails {
  ...
  factory BookingDetails.fromDTO(BookingDTO dto) {
    ...
    return BookingDetails(
      id: dto.bookingId ?? '',
      title: title,
      date: dto.scheduledStartTime?.toLocal().toString().split(' ')[0] ?? dto.bookingDate?.toLocal().toString().split(' ')[0] ?? '',
      price: priceStr,
      ...
      rawBookingDate: (dto.bookingDate ?? DateTime.now()).toLocal(),
      rawScheduledStartTime: dto.scheduledStartTime?.toLocal(),
