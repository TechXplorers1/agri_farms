...
class BookEquipmentDetailScreen extends StatefulWidget {
  ...
  @override
  State<BookEquipmentDetailScreen> createState() =>
      _BookEquipmentDetailScreenState();
}
...
class _BookEquipmentDetailScreenState extends State<BookEquipmentDetailScreen> {
  ...
  Future<void> _geocodeManualAddress() async {
    ...
    try {
      String fullAddress =
          "${_houseNoController.text}, ${_streetController.text}, ${_villageController.text}, ${_districtController.text}, ${_stateController.text}, ${_countryController.text}, ${_pincodeController.text}";
  ...
  Future<void> _pasteAddressFromClipboard() async {
    try {
      ...
      if (data != null && data.text != null && data.text!.isNotEmpty) {
        ...
        UiUtils.showCenteredToast(
          context,
          'Address pasted and filled successfully',
        );
      } else {
        UiUtils.showCenteredToast(
          context,
  ...
  void _onSlotTap(int hour) {
    ...
    setState(() {
      if (_selectedSlots.contains(hour)) {
        ...
        if (_selectedSlots.isNotEmpty) {
          _selectedSlots.sort();
          if (hour != _selectedSlots.first - 1 &&
  ...
  void _confirmBooking() async {
    ...
    if (widget.equipmentType.contains('Sprayer') &&
      ...
      UiUtils.showCenteredToast(
        context,
        'Please select at least one sprayer type',
        isError: true,
      );
    }
    ...
    if ((_selectedSlots.isNotEmpty || isDailyTrolley) &&
      ...
      if (isDailyTrolley) {
        ...
        durationText =
            '${_formatTime(_selectedSlots.first)} - ${_formatTime(_selectedSlots.last + 1)}';
      }
      ...
      if (_selectedSlots.isNotEmpty &&
        ...
        UiUtils.showCenteredToast(
          context,
          'Total price cannot be zero. Cannot book without cost info.',
          isError: true,
        );
        return;
      }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          '${l10n.rentNow} ${widget.equipmentType}',
          ...
          children: [
                      ...
                      child: CircleAvatar(
                        ...
                        backgroundImage:
                            widget.ownerProfileImage != null &&
                                    widget.ownerProfileImage!.isNotEmpty
                                ? NetworkImage(
                        ...
                        child:
                            widget.ownerProfileImage == null ||
                                    widget.ownerProfileImage!.isEmpty
                                ? const Icon(
                  ...
                  children: [
                    if (widget.attachedEquipments != null &&
                      ...
                      Wrap(
                        ...
                        children:
                            (widget.equipmentType.contains('Sprayer')
                                    ? _displaySprayerTypes
                                    : widget.attachedEquipments!)
                                .map((eq) {
                      ...
                      const Text(
                        'No attached equipments offered by this provider.',
                        style: TextStyle(
                          fontSize: 13,
            ...
            _buildSectionCard(
              ...
              isError: [
                ...
                'state',
                'pincode',
              ].any((f) => _fieldErrors.containsKey(f)),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Row(
                              ...
                              Row(
                                children: [
                                  ...
                                  _buildDurationControl(
                                    ...
                                    onPressed:
                                        _canAddMoreHours() ? _addHour : null,
                                  ),
                                ],
                              ),
                              Container(
                  ...
                  Container(
                    ...
                    child: SwitchListTile(
                      ...
                      subtitle:
                          widget.operatorAvailable
                              ? TranslatedText(
                                '+ ₹${(widget.operatorPrice ?? 200.0).toStringAsFixed(0)} / hr extra charge',
                                style: const TextStyle(
                                  fontSize: 12,
                                  color: Colors.grey,
                                  fontWeight: FontWeight.w600,
  ...
  Widget _buildAddressInputField({
    ...
    final bool hasError =
        errorKey != null && _fieldErrors.containsKey(errorKey);
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color:
                  hasError
                      ? Colors.red
                      : (enabled ? const Color(0xFFE8F5E9) : Colors.grey[300]!),
            ),
          ),
          child: TextField(
            controller: controller,
